...
- **P** — количество выполненных заданий по практике: 1 задание = 5 балл (всего не более 15)
...
> Билет включает два варианта заданий из списка ниже
...
> Билет включает общий вариант задания
